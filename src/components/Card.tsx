      ...
      >
        <div className="flex flex-col items-center">
          <div className='relative'>
            <Image src={data.author?.profileImageUrl as string} width={446} height={446} alt="" className="rounded-t-md pointer-events-none object-cover object-top h-[446px] mw-[90vw] w-[446px]" />
            <code
